...
public class ProcV {
    ...
    public static final int _color = 1234; //color debugging shapes color
	...
	static int kEyePercentTop = 25; //25
	static int kEyePercentSide = 13;//17;
	static int kEyePercentHeight = 30;//25;
	static int kEyePercentWidth = 35;//25
	//pupil detection algorithm params
	static double kFastEyeWidth = 40; //50
